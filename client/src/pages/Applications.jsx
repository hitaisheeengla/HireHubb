...
const Applications = () => {
  ...
  const updateResume = async () => {
    try {
      ...
      const{data}=await axios.post(backendURL+'/api/users/resume', formData, {headers: {Authorization: `Bearer ${token}`}})
        ...
        <div className='flex gap-2 mb-6 mt-3'>
          {
            isEdit || userData && userData.resume ===""
              ...
              : <div className='flex gap-2'>
                <a href={userData.resume} target='blank' className='bg-blue-100 text-blue-600 px-4 py-2 rounded-lg'>
                  Resume
                </a>
